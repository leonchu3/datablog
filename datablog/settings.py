"""
Django settings for datablog project.
...
SECRET_KEY = '+zn!f0lu*i--*njdce&_3=y2jt%o&l12$p&d*#&cwd9t%qo)-4'
...
WSGI_APPLICATION = 'datablog.wsgi.application'
